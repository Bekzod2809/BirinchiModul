...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        //1.3.3-juda-qiyin-27
        //var shakarNarhi = 4000;

        //for (int i = 13; i <= 60; i++)
        //{
        //    Console.WriteLine($"{i}kg shakar narhi: {i*shakarNarhi}");
        //}
        ...
        //    }
        //}
        //if (boluvchiA > boluvchiB)
        //{
        //    Console.WriteLine("a sonini bo'luchilari koproq");
        //}
        //else if (boluvchiB > boluvchiA)
        //{
        //    Console.WriteLine("b sonini bo'luchilari koproq");
        //}
        //else
        //{
        //    Console.WriteLine("Ikkalasi ham bo'luvchilari teng");
        //}
        ...
        //1.3.3-juda-qiyin-31
        //var kanfetNarhi = 10000;

        //for (decimal i = 1.1m; i <= 2.0m; i+=0.1m)
        //{
        //    Console.WriteLine($"{i}kg shakar narxi : {i*kanfetNarhi}");
        //}
        ...
        //for (int i = 0; i <= n; i++)
        //{
        //    Console.WriteLine($"{i} ning ildizi: {Math.Sqrt(i)}");
        //}
